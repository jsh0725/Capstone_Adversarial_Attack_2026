...
def parse_args():
    ...
    p.add_argument("--weights", default="weights/detectors/vhrv_yolo11x.pt", help="Detector weights path")
    p.add_argument("--gv", default="outputs/training/generators/vhrv_vresults/G_v_best.pth", help="Vanish generator checkpoint")
    p.add_argument("--gf", default="outputs/training/generators/vhrv_fresults/G_f_best.pth", help="Fabricate generator checkpoint")
    ...
    p.add_argument("--outdir", default="outputs/video_eval/vhrv")
