...
def parse_args():
    ...
    p.add_argument("--weights", default="best.pt", help="VisDrone detector weights path")
    p.add_argument("--gv", default="results/visdrone_vresults/G_v_best.pth", help="VisDrone vanish generator checkpoint")
    p.add_argument("--gf", default="results/visdrone_fresults/G_f_best.pth", help="VisDrone fabricate generator checkpoint")
    ...
    p.add_argument("--outdir", default="video_outputs/VisDrone_Limit")
